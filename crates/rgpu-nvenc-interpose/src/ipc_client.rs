//! Synchronous IPC client for NVENC commands to the RGPU daemon.
//!
//! This follows the same pattern as the CUDA interpose IPC client but without
//! command pipelining — all NVENC commands need immediate responses.
...
impl NvencIpcClient {
    ...
    pub fn send_command(&self, cmd: NvencCommand) -> Result<NvencResponse, String> {
