//! Synchronous IPC client for NVDEC commands to the RGPU daemon.
//!
//! This must be synchronous because CUVID API calls are synchronous.
//! Connects to the RGPU client daemon via named pipe (Windows) / Unix socket (Linux)
//! and sends NvdecCommand messages, receiving NvdecResponse replies.
...
/// Synchronous IPC client for NVDEC commands.
...
impl NvdecIpcClient {
    ...
    pub fn send_command(&self, cmd: NvdecCommand) -> Result<NvdecResponse, String> {
